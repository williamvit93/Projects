...
public class InsereAutores extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        
        System.out.println(" ::: SERVLET INSERE AUTORES ::: ");
        ...
        try {
            ...
            //int idAutores = Integer.parseInt(request.getParameter("txtAutores"));
            String primeiroNome = request.getParameter("primeiroNome");
            String segundoNome = request.getParameter("segundoNome");

            if ((primeiroNome == null || primeiroNome.isEmpty()) && (segundoNome == null || segundoNome.isEmpty())) {
                response.sendRedirect("Erro.jsp");
                primeiroNome = "";
                segundoNome = "";
            } else if (primeiroNome == null || primeiroNome.isEmpty()) {
                response.sendRedirect("Erro.jsp");
                primeiroNome = "";
                segundoNome = "";
            } else if (segundoNome == null || segundoNome.isEmpty()) {
                response.sendRedirect("Erro.jsp");
                primeiroNome = "";
                segundoNome = "";
            } else {
                Autores autores = new Autores(primeiroNome, segundoNome);
